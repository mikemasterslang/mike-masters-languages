        ...
        <div className="container">
          ...
          <div className="services-grid">
            <div className="service-card card fade-in">
              ...
              <p>Personalised lessons tailored to your individual needs, pace, and learning goals. Available for all three languages and all levels.</p>
              <ul className="service-features">
                {['Fully personalised curriculum', 'Flexible scheduling', 'All levels welcome', 'Exam prep or conversational focus'].map(f => (
            ...
            <div className="service-card card fade-in">
              ...
              <p>A course designed to prepare you for real conversations using my confidence-first method. You'll speak from day one and arrive in Spain confident and prepared.</p>
              <ul className="service-features">
                {['15–30 min daily practice', 'Confidence-first approach', 'Real-life scenarios', 'Mindset & strategy sessions'].map(f => (
                  <li key={f}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>{f}</li>
                ))}
              </ul>
            </div>
            <div className="service-card card fade-in">
              ...
              <p>Learn and practise alongside friends in a small, supportive group setting. Great for building conversational confidence together before your trip. Maximum group size six.</p>
              <ul className="service-features">
                {['Small group setting', 'Maximum group size six', 'Conversational focus', 'Social learning environment'].map(f => (
                  <li key={f}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>{f}</li>
                ))}
              </ul>
            </div>
            <div className="service-card card fade-in">
              ...
              <ul className="service-features">
                {['5 online sessions', 'Personalised curriculum', 'Flexible scheduling', 'Best value option'].map(f => (
                  <li key={f}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>{f}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="service-card card fade-in">
              ...
              <p>Focused GCSE and A-Level preparation. Covers reading, writing, listening, and speaking. 100% target grade record.</p>
              <ul className="service-features">
                {['GCSE & A-Level focused', 'All four skills covered', 'Past paper practice', '100% target grade record'].map(f => (
                  <li key={f}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>{f}</li>
                ))}
              </ul>
            </div>

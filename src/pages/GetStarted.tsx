      ...
      <section className="section gs-video-section">
        <div className="container">
          <div className="gs-video-wrapper fade-in">
            <iframe
              src="https://www.youtube.com/embed/aANsRG01LAs"
        ...
        <div className="container">
          <div className="course-feature-grid">
            <div className="course-feature-content fade-in-left">
              ...
              <a href="https://buy.stripe.com/4gM28q6mE5qZ5u782j9IQ0b" className="btn btn-primary" style={{ marginTop: '1.5rem', display: 'inline-block' }}>Buy Now for 25% Off</a>
            </div>
        ...
        <div className="container">
          <div className="course-feature-grid">
            ...
            <div className="course-feature-content fade-in-right">
              ...
              <a href="https://buy.stripe.com/aFacN44ew4mVbSveqH9IQ0a" className="btn btn-primary" style={{ marginTop: '1.5rem', display: 'inline-block' }}>Buy Now for 25% Off</a>
            </div>
          </div>
        </div>
      </section>
